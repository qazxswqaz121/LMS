                                                ...
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <!-- <td class="center">
                                                            ...
                                                            <a href="edit-author.php?athrid=<?php echo htmlentities(string: $result->id); ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button>
                                                        ...
                                                        <td class="center">
                                                            <span class="tooltip-container">
                                                                <a href="edit-author.php?athrid=<?php echo htmlentities(string: $result->id); ?>">
